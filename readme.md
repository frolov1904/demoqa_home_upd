...
- Переход между страницами, работа с формами, таблицами, модальными окнами.
...
|---------------|------------|--------------------|
| 5.0 (текущая) | 2025-08-17 | Добавлены страницы `herokuapp.py`, `herokuapp_add.py`, `webtables.py`; тесты `test_btn_add`, `test_webtables`, `test_css`; поддержка CSS-стилей и alert-ов. |
| 4.0           | 2025-08-14 | Переработка components.py, страницы text_box.py и form_page, тесты текстовых форм. |
| 3.0           | 2025-08-13 | ModalDialogsPage, тесты модалок, метод `find_elements()`, новые тесты форм и SEO. |
...
- Работа с формами, таблицами, CSS-стилями, модальными окнами и alert-ами.
